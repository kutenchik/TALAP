...
export function RecommendationsPage() {
  ...
  return <DesktopShell currentStep={3} contextPanel={context}><div className="page-content recommendations-page"><header className="page-heading"><Badge>RECOMMENDATIONS</Badge><h1 className="page-title">Your university recommendations</h1><p>These universities are ordered using the evidence currently available for your profile.</p><p className="caption">Missing data is shown as unavailable rather than inferred.</p></header>
